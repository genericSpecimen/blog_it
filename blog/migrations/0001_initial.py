# Generated by Django 3.2.1 on 2021-05-16 07:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(blank=True, help_text="Select zero or more categories, or <a href='/blog/blog/category-create/'>click here</a> to create a new category.", to='blog.BlogCategory')),
            ],
            options={
                'ordering': ['-post_date'],
            },
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('follower_user', 'following_user'), name='unique_user_following'),
        ),
    ]
